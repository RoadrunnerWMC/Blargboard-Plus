...
<html>
	...
	if (version_compare(PHP_VERSION, '5.3.0') < 0)
		die($header.'Sorry, Blargboard Plus requires PHP 5.3 or above.'.$footer);
		...
		<div class="container">
			<div class="outline">
				...
				<div class="box cell center">
					The Blargboard Plus installation was successful. You may now <a href="./?page=login">proceed to your board and login</a>. Thanks for choosing Blargboard Plus!
				</div>
			</div>
		</div>
	<?php
